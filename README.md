...
AIO Bridge 是一款本地创意工作流工具，用于在网页、Photoshop、Illustrator、Eagle 与 AI 画布之间快速传输图片与视频素材。

它通过本地 Bridge 服务连接 Chrome 扩展、Photoshop UXP 插件、Illustrator CEP 插件、Eagle 插件与桌面端。用户主动选择图片或视频后，即可发送到支持的目标软件、画布或 AI 对话场景，减少重复下载、保存、导入和上传。
...
- **素材发送到 Illustrator**  
  将网页、Photoshop 或 Eagle 中主动选择的图片发送到 Illustrator，并自动置入当前文档继续编辑。
